...
<body>
	<form id="writeForm">
		<input type="text" id="artistName" placeholder="아티스트의 이름" required="required"/><br/>
		<input type="date" id="debutDate" placeholder="데뷔날짜" required="required"/><br/>
		<input type="text" id="debutTitle" placeholder="데뷔 곡" required="required"/><br/>
